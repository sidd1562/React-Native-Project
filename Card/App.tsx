    ...
    <ScrollView keyboardShouldPersistTaps='handled'>
      ...
      <SafeAreaView>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={styles.title}>PasswordGenerated</Text>
            ...
            {({
              ...
              <>
                ...
                <View style={styles.inputWrapper}>
                  ...
                  <Text style={styles.heading}>Include lowrcase</Text>
                ...
                <View style={styles.formActions}>
                  ...
                  ><Text style={styles.primaryBtnTxt}>Generated Password</Text></TouchableOpacity>
